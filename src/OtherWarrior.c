...
{
    ((OtherWarrior *)self)->instance->position->setX(((OtherWarrior *)self)->instance->position, x);
    ((OtherWarrior *)self)->instance->position->setY(((OtherWarrior *)self)->instance->position, y);
